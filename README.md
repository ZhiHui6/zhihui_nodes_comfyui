...
<tr>
<td><b>万相提示词生成器</b><br><code>WanPromptGenerator</code></td>
<td>

全能型提示词生成器，支持自定义组合和预设组合两种模式，涵盖摄影、场景、光线、镜头等15个维度的专业视频提示词生成。

<b>特点</b>：
- <b>双模式切换</b>：支持自定义组合和预设组合模式，通过开关按钮一键切换
- <b>丰富预设</b>：内置5种专业预设组合（电影级画面、动作风格、记录风格、浪漫风格、恐怖风格）
- <b>多维度选择</b>：涵盖主体类型、场景类型、光源类型、光线类型、时间段、景别、构图、镜头焦段、机位角度、镜头类型、色调、运镜方式、人物情绪、运动类型、视觉风格、特效镜头等15个专业维度
- <b>智能扩写</b>：支持多种LLM模型（OpenAI、Claude、DeepSeek、Gemini等）免费在线扩写
- <b>补充提示词</b>：支持多行文本输入的补充提示词，自动追加入提示词文本。
</td>
</tr>
<tr>
