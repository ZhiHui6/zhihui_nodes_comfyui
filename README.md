...
- **功能**: 提供20余项专业的图像变换预设，内置免费在线扩写功能，支持用户自定义预设，为图像编辑提供创意指导。
- **特点**:
    - **丰富预设库**: 包含情境深度融合、无痕融合、场景传送、移动镜头等20余项专业预设。
    - **双预设系统**: 支持默认预设和用户自定义预设，通过分类标识区分预设来源。
    - **AI智能扩写**: 支持多种LLM模型（OpenAI、Mistral、Qwen等）对预设内容进行创意扩写。
    - **双预设加载**: 除默认的预设文件外，还支持额外的用户预设文件，用户自由新增创意更多预设。
